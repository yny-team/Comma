...
<head>
    ...
    <title>MyPage ch_email | Triangle</title>
                    ...
                    <div class="sidebar portfolio-sidebar">
                        <div class="sidebar-item categories">
                            ...
                            <ul class="nav navbar-stacked">
                                ...
                                <li class="active"><a href="#">이메일 변경</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <h2 style="text-align: center;">이메일 주소 변경</h2> <br>
              <div class="col-md-9 col-sm-8">
                  <div style="width: 300px; margin: auto;margin-bottom: 30px;">
                    <p>이메일 주소</p>
                    <input type="email" name="name" class="form-control" required="required" placeholder="aaa@gmail.com"><br>
                    <input type="submit" name="submit" class="btn btn-submit" style="width: 100px;margin-right: 30px;" value="Cancel">
                    <input type="submit" name="submit" class="btn btn-submit" style="width: 100px;" value="Save">
                </div>
                <div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="copyright-text text-center">
                        <p>&copy; YNY 2021. All Rights Reserved.</p>
